...
var newGuests = ["Allama Iqbal", "Tipu Sultan", "My Father", "Ahmed", "Ali", "umar"];
console.log("I am reaaly sorry everyone that the table is not available on the party day so we need to reduce the guests");
var friend1 = newGuests.pop();
console.log(" Sorry Dear ".concat(friend1, " , You are not invited for the dinner"));
var friend2 = newGuests.pop();
console.log(" Sorry Dear ".concat(friend2, " , You are not invited for the dinner"));
var friend3 = newGuests.pop();
console.log(" Sorry Dear ".concat(friend3, " , You are not invited for the dinner"));
var friend4 = newGuests.pop();
console.log(" Sorry Dear ".concat(friend4, " , You are not invited for the dinner"));
console.log("Dear ".concat(newGuests[0], " , \"you are still invited\""));
console.log("Dear ".concat(newGuests[1], " , \"you are still invited\""));
